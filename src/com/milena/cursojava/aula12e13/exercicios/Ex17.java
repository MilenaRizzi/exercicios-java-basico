...
public class Ex17 {
    public static void main(String[] args) {
        ...
        double litro = tamanho / 6;
        double precoTotalLata = (80*litro) / 18;
        double precoTotalGaloes = (25 * litro) / 3.6;

        System.out.println("Preço se comprar apenas latas de 18 litros " + precoTotalLata);
        System.out.println("Preço se comprar apenas galões de 3,6 litros " + precoTotalGaloes);
    }
}
